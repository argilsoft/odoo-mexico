...
#        'import_id': fields.many2one('import.info', 'Pedimento Aduanal', required=True),
#        'qty': fields.float('Cantidad', (16, 4)),
#        'uom_id': fields.many2one('product.uom', 'UdM', required=False,
#            help="Unidad de Medida, tenga en cuenta que esta unidad de medida debe pertenecer a la misma Categoría de Unidad de Medida a la que pertenece la Unidad de Medida en el formulario de producto"),
